...
export interface SurveyQuestion {
  ...
  maxSelections?: number;      // multi_choice — enforced by the UI and re-checked server-side
  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        ...
        { id: 'q31_most_useful_features', type: 'multi_choice', required: true, maxSelections: 5, label: 'Which features would be most useful to you?', helpText: 'Choose up to 5.', options: ['Quick screening', 'Facial scan', 'Questionnaire', 'Clear risk score', 'Risk explanation', 'Symptom tracking', 'Snoring and sleep monitoring', 'Repeat screening', 'Next-step guidance', 'When to see a doctor', 'Which specialist to see', 'Nearby centres', 'Cost estimate', 'Booking tools', 'Download report', 'Share report', 'Other'] },
        ...
        { id: 'q35_high_risk_support', type: 'multi_choice', required: true, maxSelections: 3, label: 'After receiving a high-risk result, what support would you want?', helpText: 'Select up to 3.', options: ['Explanation of the result', 'Do I need a doctor?', 'Recommendation of a professional', 'Finding a clinic', 'Cost information', 'Booking assistance', 'Doctor report provided', 'Monitor while waiting', 'Reminders', 'Other'] },
